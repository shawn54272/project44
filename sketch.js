...
function draw() {
  ...
  if(gameState === instruction) {
    ...
    textSize(50);
    text("------SPACE SHOOTERS------",canvas.width/2-300,canvas.height/2-200);
    text("ENJOY THE GAME!",canvas.width/2-300,canvas.height/2+200);
    stroke("blue");
    fill("blue");
    textSize(35);
    textFont("Apple Chancery");
    text("year 2500 .....",canvas.width/2-300,canvas.height/2-150);
    text(" Some asteroids are coming towords Earth.",canvas.width/2-300, canvas.height/2 - 110);
    text("  You are a space fighter.",canvas.width/2-300,canvas.height/2-70);
    text("  Help the people and Earth !",canvas.width/2-200,canvas.height/2-30);
    text("  press 'space' to shoot.",canvas.width/2-200,canvas.height/2+10);
    text("  use right and left arrows to move.",canvas.width/2-300,canvas.height/2+50);
    text("  press 's' to start game.",canvas.width/2,canvas.height/2+80);
...
function asteroids() {
  if(frameCount % 110 === 0) {
    ...
    var asteroid = createSprite(Math.round(random(50,900)),-20);
